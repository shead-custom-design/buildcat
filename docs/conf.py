...
# -*- coding: utf-8 -*-
#
# Buildcat documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'Buildcat.tex', u'Buildcat Documentation',
     u'Timothy M. Shead', 'manual'),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
#latex_logo = "../artwork/buildcat.png"
...
man_pages = [
    (master_doc, 'buildcat', u'Buildcat Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Buildcat', u'Buildcat Documentation',
     author, 'Buildcat', 'One line description of project.',
     'Miscellaneous'),
]
