...
trapped inside monolithic tools like `make` and `SCons`.  Use Buildcat to
process data, run scientific experiments, generate documentation, or handle any
other build automation task.  Some key Buildcat features:
